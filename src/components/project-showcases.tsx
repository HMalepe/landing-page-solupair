...
function ChatBubble({
  ...
  return (
    ...
    >
      <div
        className={`max-w-[85%] rounded-2xl px-2.5 py-1.5 text-[9px] leading-snug sm:text-[10px] ${
          isBot
...
/** 04 — WhatsApp booking agent conversation */
export function WhatsAppChatbotPreview() {
  ...
  return (
    <div className="flex h-full w-full items-center justify-center bg-gradient-to-br from-[#0b141a] via-[#111b21] to-[#0b141a] p-3 sm:p-5">
      <div className="flex h-full max-h-[100%] w-full max-w-[220px] flex-col overflow-hidden rounded-[1.75rem] border border-white/10 bg-[#0b141a] shadow-[0_20px_60px_oklch(0_0_0_/_0.5)] sm:max-w-[260px]">
        {/* Phone status bar */}
        ...
        <div className="flex items-center gap-2 border-b border-white/5 bg-[#1f2c34] px-3 py-2.5">
          ...
          <div className="min-w-0 flex-1">
            <p className="truncate text-[10px] font-semibold text-white">Solupair Booking</p>
        ...
        {/* Chat wallpaper */}
        <div
          className="flex min-h-0 flex-1 flex-col justify-end gap-2 overflow-hidden p-2.5"
          style={{
            backgroundImage:
        ...
        >
          <ChatBubble from="bot" delay={0}>
            Hi! 👋 Welcome to Glow Studio. Reply with a number:
            <br />
            1 Book · 2 Services · 3 Hours
          </ChatBubble>
          <ChatBubble from="user" delay={0.2}>
            1
          </ChatBubble>
          <ChatBubble from="bot" delay={0.4}>
            Great! Pick a service:
            <br />
            1 Haircut · 2 Colour · 3 Treatment
          </ChatBubble>
          <ChatBubble from="user" delay={0.55}>
            1
          </ChatBubble>
          <ChatBubble from="bot" delay={0.7}>
            ✅ Thu 14 Mar · 10:30 with Thandi
            <br />
            Reply <strong>YES</strong> to confirm
          </ChatBubble>
